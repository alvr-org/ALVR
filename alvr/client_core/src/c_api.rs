...
/// To be used when no frame was submit for this vsync, and the previous frame is reprojected
#[no_mangle]
pub extern "C" fn alvr_report_reprojected(frame_interval_ns: u64) {
    crate::report_reprojected(Duration::from_nanos(frame_interval_ns));
}
