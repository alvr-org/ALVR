    ...
    return function (alvrSettings) {
        ...
        let latencyGraphOptions = {
            ...
            series: [
                ...
                getSeries(i18n["performanceReceive"], graphColors[0], graphColors[0], latencyGraphData, " ms"),
                getSeries(i18n["performanceRender"], graphColors[1], graphColors[1], latencyGraphData, " ms"),
                getSeries(i18n["performanceIdle"], graphColors[2], graphColors[2], latencyGraphData, " ms"),
                getSeries(i18n["performanceEncode"], graphColors[3], graphColors[3], latencyGraphData, " ms"),
                getSeries(i18n["performanceSend"], graphColors[0], graphColors[0], latencyGraphData, " ms"),
                getSeries(i18n["performanceDecode"], graphColors[3], graphColors[3], latencyGraphData, " ms"),
            ],
        };
        ...
        let framerateGraphOptions = {
            ...
            series: [
                ...
                getSeries(i18n["performanceServer"], graphColors[3], null, framerateGraphData, " FPS"),
                getSeries(i18n["performanceClient"], graphColors[2], null, framerateGraphData, " FPS"),
            ],
        };
