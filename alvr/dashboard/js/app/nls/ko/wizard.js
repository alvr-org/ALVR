define({
        ...
        "textHardwareReq": "ALVR은 전용 및 최신 그래픽카드가 필요합니다. <br/> <br/> 오디오 출력 장치가 하나 이상 있는지 확인하세요 <br/> <br/> ",
        "YourGPUIs": "현재 그래픽카드:",
        "GPUSupported": " \n지원되는 그래픽카드 입니다.",
        ...
        // Tracking page
        "titleTracking": "트래킹",
        "textTracking": "컨트롤러 트래킹 설정입니다. 비트세이버처럼 빠른 속도의 게임을 플레이하신다면 보통 혹은 중간을 선택하세요. 스카이림처럼 느린 게임을 플레이하신다면 보통을 선택하세요. 오큘러스 예측은 SteamVR 대신 헤드셋에서 컨트롤러 위치를 예측합니다.",
