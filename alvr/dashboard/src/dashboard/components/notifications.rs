...
const NOTIFICATION_TIPS: &[&str] = &[
    ...
    r#"If you started having crashes after changing some settings, reset ALVR by re-running "Run setup wizard" from the "Installation" tab and resetting settings in the wizard."#,
    r#"Some settings are hidden by default. Click the "Expand" button next to some settings to expand the submenus."#,
    r#"It's highly advisable to keep the audio setting as default in ALVR and modify the default audio device in the taskbar tray."#,
    ...
    r#"ALVR supports custom button bindings! If you need help, please ask us on the Discord server."#,
    ...
    r#"You can quickly cycle through tips like this one by toggling the "Show notification tip""#,
