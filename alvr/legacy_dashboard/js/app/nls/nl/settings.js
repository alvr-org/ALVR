define({
    ...
    "_root_video_displayRefreshRate.description": "Verversingssnelheid is ingesteld voor SteamVR en de headset. Hogere waarden hebben een snellere pc nodig. 72 Hz is het limiet voor de Quest 1.",
    ...
    "_root_video_foveatedRendering_content_strength.description": "Een hogere waarde betekent minder detail aan de randen van het frame en meer artefacten",
    "_root_video_foveatedRendering_content_verticalOffset.name": "Verticale offset",
    "_root_video_foveatedRendering_content_verticalOffset.description": "Een hogere waarde betekent het framegebied van hoge kwaliteit wordt verder naar beneden bewogen",
    ...
    "_root_video_colorCorrection_enabled.description": "Kleur correctie wordt toegepast in de volgende volgorde: verscherping, gamma, helderheid, contrast en verzadiging.",
    "_root_video_colorCorrection_content_brightness.name": "Helderheid",
    "_root_video_colorCorrection_content_brightness.description": "Helderheid: -1 betekent volledig zwart en 1 betekent volledig wit.",
    "_root_video_colorCorrection_content_contrast.name": "Contrast",
    "_root_video_colorCorrection_content_contrast.description": "Contrast: -1 betekent volledig grijs.",
    "_root_video_colorCorrection_content_saturation.name": "verzadiging",
    "_root_video_colorCorrection_content_saturation.description": "verzadiging: -1 betekent dat het beeld wit en zwart is.",
    "_root_video_colorCorrection_content_gamma.name": "Gamma",
    "_root_video_colorCorrection_content_gamma.description": "Gamut: Gebruik een waarde van 2,2 om de kleur van sRGB naar RGB te corrigeren. Dit regelt de helderheid maar houdt zwart in zwart en wit in wit",
    "_root_video_colorCorrection_content_sharpening.name": "Verscherping",
    "_root_video_colorCorrection_content_sharpening.description": "Scherpte: benadrukt de randen van het beeld.",
    "_root_video_codec-choice-.name": "Video codering",
    "_root_video_codec-choice-.description": "HEVC is de voorkeur om een ​​betere visuele kwaliteit te bereiken bij lagere bitrates. AMD videokaarten werkt het best met HEVC.",
    ...
    "_root_video_encodeBitrateMbs.description": "Bitrate van video streaming. 30Mbps is aangeraden. \nHogere bitrates zorgen voor een beter beeld maar verhoogd de latency en netwerk verkeer",
    // Audio tab
    ...
    "_root_audio_gameAudio_content_deviceId-choice-.description": "Selecteer het audio apparaat gebruikt om audio vast te leggen",
    ...
    "_root_audio_microphone_content_deviceId-choice-.description": "Selecteer de virtuele microfoon input gebruikt om audio vast te leggen. \nOm de microfoon te laten werken moet je VB-Audio Virtual device of een gelijksoortige software instaleren",
    // Headset tab
    "_root_headset_tab.name": "Headset",
    "_root_headset_headsetEmulationMode.name": "Headset emulatie modus",
    "_root_headset_headsetEmulationMode.description": "Emuleert verschillende headsets voor een betere compatibiliteit",
    ...
    "_root_headset_controllers_content_controllerMode.description": "Emuleert verschillende controllers voor betere compatibiliteit of maakt handvolging mogelijk",
    ...
    "_root_extra_clientDarkMode.description": "Toegepast nadat de headset opnieuw verbonden en uit slaap modus gehaald wordt",
    "_root_extra_revertConfirmDialog.name": "Bevestig terugzetten instellingen",
    "_root_extra_revertConfirmDialog.description": "Vraag bevestiging voordat instellingen naar hun standaardwaarden teruggezet worden.",
    ...
    "audioDeviceError": "Geen audio apparaten gevonden. Men kan de audio of de microfoon niet streamen",
});
