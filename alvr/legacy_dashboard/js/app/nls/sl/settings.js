define({
    ...
    "_root_video_displayRefreshRate.description": "Hitrost osveževanja za SteamVR in napravo. SteamVR bo uporabil to hitrost tudi če je naprava ne podpira. Višje vsote zahtevajo zmogljivejši PC. 72 Hz je najhitrejše kar Quest 1 podpira.",
    "_root_video_preferredFps.name": "Osveževanje po meri", // adv
    "_root_video_resolutionDropdown.name": "Ločljivost slike",
    "_root_video_resolutionDropdown.description": "100% je mehanska ločljivost Oculus Quest-a. \nZvišanje ločljivosti lahko izbolša sliko, a ni priporočeno. \nLočljivost nižja od 100% lahko skrajša zaostanek.",
    ...
    "_root_video_secondsFromVsyncToPhotons.description": "Čas, ki preteče od navideznega VSync-a do vidne slike na zaslonu.", // adv
    ...
    "_root_video_foveatedRendering_enabled.description": "Upodobitven način, ki zamnjša ločljivost slike v obrobju, kar zamnjša obremenitev na GPE in omogoča bolj jasno sliko pri nižjem toku podatkov.",
    "_root_video_foveatedRendering_content_strength.name": "Moč",
    "_root_video_foveatedRendering_content_strength.description": "Višja vsota pomeni manjša ločljivost in več napak v obrobju.",
    ...
    "_root_video_foveatedRendering_content_verticalOffset.description": "Višja vsota premakne oster del slike nižje na samem zaslonu.",
    ...
    "_root_video_colorCorrection_enabled.description": "Prilagoditev je uveljavljena v sledečem vrstnem redu: Ostrina, Gamma, Svetlost, Kontrast in Barvitost.",
    "_root_video_colorCorrection_content_brightness.name": "Svetlost",
    "_root_video_colorCorrection_content_brightness.description": "Svetlost: Na -1 je slika popolnoma črna in na 1 čisto bela.",
    "_root_video_colorCorrection_content_contrast.name": "Kontrast",
    "_root_video_colorCorrection_content_contrast.description": "Kontrast: Na -1 bo slika popolnoma siva.",
    "_root_video_colorCorrection_content_saturation.name": "Barvitost",
    "_root_video_colorCorrection_content_saturation.description": "Barvitost: Na -1 je slika črnobela, na več kot 0 so lahko barve prenasičene.",
    "_root_video_colorCorrection_content_gamma.name": "Gamma",
    "_root_video_colorCorrection_content_gamma.description": "Gamma: To spreminja svetlost, ampak obdrži belo belo in črno črno.",
    "_root_video_colorCorrection_content_sharpening.name": "Ostrina",
    "_root_video_colorCorrection_content_sharpening.description": "Ostrina: Poudari kontrastne robove.",
    ...
    "_root_video_clientRequestRealtimeDecoder.name": "Zahtevaj najhitrejšo različico razlagovalca (naprava)", // adv
    "_root_video_encodeBitrateMbs.name": "Podatkovni tok videa",
    "_root_video_encodeBitrateMbs.description": "Podatkovni tok video prenosa. Predlagana vsota je 10% zmožnosti brezžične povezave.(Naprava>Nastavitve>Omrežja>Trenutno omrežje>Podrobnosti) \nVišji tok izboljša sliko a podlaša zaostanek in obratno.",
    // Audio tab
    ...
    "_root_audio_gameAudio_content_deviceId-choice-.description": "Izberi od katere naprave bo zvok zajet.",
    ...
    "_root_audio_microphone_content_deviceId-choice-.description": "Izberi zvočno napravo preko katere bo zvok mikrofona predvajan.",
    // Headset tab
    "_root_headset_tab.name": "NAPRAVA",
    "_root_headset_headsetEmulationMode.name": "Izberi kater HMD naj bo posneman",
    "_root_headset_headsetEmulationMode.description": "Posnema različne naprave za boljšo združljivost.",
    ...
    "_root_headset_controllers_content_controllerMode.description": "Posnema različne krmilnike za bolšjo združljivost in sledenje prstom.",
    ...
    "_root_extra_revertConfirmDialog.description": "Vprašaj za potrditev, preden se nastavitev povrne.",
    ...
    "_root_extra_notificationLevel-choice-.description": "Na kateri stopnji se bodo opozorila pojavila. Od manj do več podrobnosti: \n - Napaka \n - Opozorilo \n - podrobnosti \n - Razhrošč", // adv
