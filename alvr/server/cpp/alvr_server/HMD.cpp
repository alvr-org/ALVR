...
Hmd::Hmd()
    ...
    this->views_config.local_view_transforms[0] = identity_pose;
    this->views_config.local_view_transforms[1] = identity_pose;
...
void Hmd::SetViewsConfig(FfiViewsConfig config) {
    ...
    auto left_transform = pose_to_transform(config.local_view_transforms[0]);
    auto right_transform = pose_to_transform(config.local_view_transforms[1]);
