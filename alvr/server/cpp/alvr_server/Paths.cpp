...
void init_paths() {
    ...
    LEFT_SQUEEZE_CLICK = PathStringToHash("/user/hand/left/input/squeeze/click");
    LEFT_SQUEEZE_VALUE = PathStringToHash("/user/hand/left/input/squeeze/value");
    LEFT_TRIGGER_CLICK = PathStringToHash("/user/hand/left/input/trigger/click");
    ...
    RIGHT_SQUEEZE_CLICK = PathStringToHash("/user/hand/right/input/squeeze/click");
    RIGHT_SQUEEZE_VALUE = PathStringToHash("/user/hand/right/input/squeeze/value");
    RIGHT_TRIGGER_CLICK = PathStringToHash("/user/hand/right/input/trigger/click");
    ...
    LEFT_CONTROLLER_BUTTONS.push_back(LEFT_SQUEEZE_CLICK);
    LEFT_CONTROLLER_BUTTONS.push_back(LEFT_SQUEEZE_VALUE);
    LEFT_CONTROLLER_BUTTONS.push_back(LEFT_TRIGGER_CLICK);
    ...
    RIGHT_CONTROLLER_BUTTONS.push_back(RIGHT_SQUEEZE_CLICK);
    RIGHT_CONTROLLER_BUTTONS.push_back(RIGHT_SQUEEZE_VALUE);
    RIGHT_CONTROLLER_BUTTONS.push_back(RIGHT_TRIGGER_CLICK);
