...
alvr::EncodePipelineSW::EncodePipelineSW(std::vector<VkFrame>& input_frames, VkFrameCtx& vk_frame_ctx)
{
  ...
  switch (codec_id)
  {
    ...
    case ALVR_CODEC_H265:
      ...
      av_dict_set(&opt, "kvazaar-params", "preset=ultrafast,no-info=true,no-psnr=true,owf=0,ref=1", 0);
      break;
  }
...
void alvr::EncodePipelineSW::EncodeFrame(uint32_t frame_index, bool idr, std::vector<uint8_t>& out)
{
