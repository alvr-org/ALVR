...
extern "C"
{
   ...
   VKAPI_ATTR VkResult VKAPI_CALL wsi_layer_vkGetPhysicalDeviceDisplayPropertiesKHR(VkPhysicalDevice device,
   ...
   VKAPI_ATTR VkResult VKAPI_CALL wsi_layer_vkGetDisplayModePropertiesKHR(VkPhysicalDevice device, VkDisplayKHR display,
                                                                          uint32_t *pPropertyCount,
      ...
      VkPhysicalDevice device, uint32_t *pPropertyCount, VkDisplayPlanePropertiesKHR *pProperties)
   {
      ...
      VkResult result = instance.disp.GetPhysicalDeviceDisplayPlanePropertiesKHR(device, pPropertyCount, pProperties);
   ...
   VKAPI_ATTR VkResult VKAPI_CALL wsi_layer_vkAcquireXlibDisplayEXT(VkPhysicalDevice device, Display *dpy,
   ...
   VKAPI_ATTR VkResult VKAPI_CALL wsi_layer_vkGetDisplayPlaneSupportedDisplaysKHR(VkPhysicalDevice physicalDevice,
                                                                                  uint32_t planeIndex,
                                                                                  uint32_t *pDisplayCount,
                                                                                  VkDisplayKHR *pDisplays)
   {
      auto &instance = layer::instance_private_data::get(physicalDevice);
      if (planeIndex >= instance.first_plane_index and planeIndex < instance.first_plane_index + instance.num_planes)
      {
         *pDisplayCount = 1;
         if (pDisplays)
         {
      ...
      return instance.disp.GetDisplayPlaneSupportedDisplaysKHR(physicalDevice, planeIndex, pDisplayCount, pDisplays);
   }

   VKAPI_ATTR VkResult VKAPI_CALL
   wsi_layer_vkCreateDisplayPlaneSurfaceKHR(VkInstance vkinstance, const VkDisplaySurfaceCreateInfoKHR *pCreateInfo,
