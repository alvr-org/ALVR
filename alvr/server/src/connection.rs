...
async fn client_handshake(
    ...
    let new_openvr_config = OpenvrConfig {
        ...
        foveation_center_size_x: session_settings.video.foveated_rendering.content.center_size_x,
        foveation_center_size_y: session_settings.video.foveated_rendering.content.center_size_y,
        foveation_center_shift_x: session_settings.video.foveated_rendering.content.center_shift_x,
        foveation_center_shift_y: session_settings.video.foveated_rendering.content.center_shift_y,
        foveation_edge_ratio_x: session_settings.video.foveated_rendering.content.edge_ratio_x,
        foveation_edge_ratio_y: session_settings.video.foveated_rendering.content.edge_ratio_y,
