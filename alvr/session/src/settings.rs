...
pub struct ControllersDesc {
    ...
    pub steamvr_hmd_predication_multiplier: f32,

    #[schema(advanced, min = -2.0, max = 2.0, step = 0.01)]
    pub steamvr_ctrl_predication_multiplier: f32,
        ...
        headset: HeadsetDescDefault {
            ...
            controllers: SwitchDefault {
                ...
                content: ControllersDescDefault {
                    ...
                    steamvr_hmd_predication_multiplier: 1.0,
                    steamvr_ctrl_predication_multiplier: 0.0,
