...
pub enum EntryType {
    ...
    HigherOrder {
        ...
        // Contains code interpreted by the UI
...
pub struct SchemaChoice {
    pub default: String,
    pub variants: Vec<(String, Option<EntryData>)>,
    pub gui: Option<ChoiceControlType>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct SchemaOptional {
    pub default_set: bool,
    pub content: Box<SchemaNode>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct SchemaSwitch {
    pub default_enabled: bool,
    pub content_advanced: bool,
    pub content: Box<SchemaNode>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct SchemaNumeric<T> {
    pub default: T,
    pub min: Option<T>,
    pub max: Option<T>,
    pub step: Option<T>,
    pub gui: Option<NumericGuiType>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct SchemaVector {
    pub default_element: Box<SchemaNode>,
...
pub struct SchemaDictionary {
    ...
    pub default_value: Box<SchemaNode>,
...
pub enum SchemaNode {
    ...
    Switch(SchemaSwitch),
    Boolean(bool),
    Integer(SchemaNumeric<i128>),
    Float(SchemaNumeric<f64>),
    Text(String),
