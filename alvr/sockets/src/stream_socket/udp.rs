...
impl MultiplexedSocketReader for MultiplexedUdpReader {
    ...
    fn recv(&mut self, stream_queues: &HashMap<u16, StreamRecvQueues>) -> ConResult {
        ...
        let size = crate::socket_peek(&mut self.inner, &mut prefix_bytes)?;
        ...
        // Note: in unexpected circumstances, here .to_con() does not emit TryAgain, which would
        // mess with the state of the code. The connection would need to be closed instead.
