...
void OvrController::GetBoneTransform(bool withController, bool isLeftHand, const TrackingInfo::Controller &c, vr::VRBoneTransform_t m_boneTransform[]) {
	...
	if (isLeftHand) {
		...
		//open hand -> base
		m_boneTransform[0] = { {0.000000, 0.000000, 0.000000, 1}, {1.000000, -0.000000 , -0.000000 , 0.000000} };
		m_boneTransform[1] = { {-0.034038, 0.036503, 0.164722, 1}, {-0.055147, -0.078608 , -0.920279 , 0.379296} };
		m_boneTransform[2] = { {-0.012083, 0.028070, 0.025050, 1}, {0.464112, 0.567418 , 0.272106 , 0.623374} };
		m_boneTransform[3] = { {0.040406, 0.000000, -0.000000, 1}, {0.994838, 0.082939 , 0.019454 , 0.055130} };
		m_boneTransform[4] = { {0.032517, 0.000000, 0.000000, 1}, {0.974793, -0.003213 , 0.021867 , -0.222015} };
		m_boneTransform[5] = { {0.030464, -0.000000, -0.000000, 1}, {1.000000, -0.000000 , 0.000000 , 0.000000} };
		m_boneTransform[6] = { {0.000632, 0.026866, 0.015002, 1}, {0.644251, 0.421979 , -0.478202 , 0.422133} };
		m_boneTransform[7] = { {0.074204, -0.005002, 0.000234, 1}, {0.995332, 0.007007 , -0.039124 , 0.087949} };
		m_boneTransform[8] = { {0.043930, -0.000000, -0.000000, 1}, {0.997891, 0.045808 , 0.002142 , -0.045943} };
		m_boneTransform[9] = { {0.028695, 0.000000, 0.000000, 1}, {0.999649, 0.001850 , -0.022782 , -0.013409} };
		m_boneTransform[10] = { {0.022821, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , -0.000000 , 0.000000} };
		m_boneTransform[11] = { {0.002177, 0.007120, 0.016319, 1}, {0.546723, 0.541277 , -0.442520 , 0.460749} };
		m_boneTransform[12] = { {0.070953, 0.000779, 0.000997, 1}, {0.980294, -0.167261 , -0.078959 , 0.069368} };
		m_boneTransform[13] = { {0.043108, 0.000000, 0.000000, 1}, {0.997947, 0.018493 , 0.013192 , 0.059886} };
		m_boneTransform[14] = { {0.033266, 0.000000, 0.000000, 1}, {0.997394, -0.003328 , -0.028225 , -0.066315} };
		m_boneTransform[15] = { {0.025892, -0.000000, 0.000000, 1}, {0.999195, 0.000000 , 0.000000 , 0.040126} };
		m_boneTransform[16] = { {0.000513, -0.006545, 0.016348, 1}, {0.516692, 0.550144 , -0.495548 , 0.429888} };
		m_boneTransform[17] = { {0.065876, 0.001786, 0.000693, 1}, {0.990420, -0.058696 , -0.101820 , 0.072495} };
		m_boneTransform[18] = { {0.040697, 0.000000, 0.000000, 1}, {0.999545, -0.002240 , 0.000004 , 0.030081} };
		m_boneTransform[19] = { {0.028747, -0.000000, -0.000000, 1}, {0.999102, -0.000721 , -0.012693 , 0.040420} };
		m_boneTransform[20] = { {0.022430, -0.000000, 0.000000, 1}, {1.000000, 0.000000 , 0.000000 , 0.000000} };
		m_boneTransform[21] = { {-0.002478, -0.018981, 0.015214, 1}, {0.526918, 0.523940 , -0.584025 , 0.326740} };
		m_boneTransform[22] = { {0.062878, 0.002844, 0.000332, 1}, {0.986609, -0.059615 , -0.135163 , 0.069132} };
		m_boneTransform[23] = { {0.030220, 0.000000, 0.000000, 1}, {0.994317, 0.001896 , -0.000132 , 0.106446} };
		m_boneTransform[24] = { {0.018187, 0.000000, 0.000000, 1}, {0.995931, -0.002010 , -0.052079 , -0.073526} };
		m_boneTransform[25] = { {0.018018, 0.000000, -0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
		m_boneTransform[26] = { {-0.006059, 0.056285, 0.060064, 1}, {0.737238, 0.202745 , 0.594267 , 0.249441} };
		m_boneTransform[27] = { {-0.040416, -0.043018, 0.019345, 1}, {-0.290330, 0.623527 , -0.663809 , -0.293734} };
		m_boneTransform[28] = { {-0.039354, -0.075674, 0.047048, 1}, {-0.187047, 0.678062 , -0.659285 , -0.265683} };
		m_boneTransform[29] = { {-0.038340, -0.090987, 0.082579, 1}, {-0.183037, 0.736793 , -0.634757 , -0.143936} };
		m_boneTransform[30] = { {-0.031806, -0.087214, 0.121015, 1}, {-0.003659, 0.758407 , -0.639342 , -0.126678} };
		...
		if (withController) {
			//thumb
			//y touch
			if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_Y_TOUCH)) != 0) {
				m_boneTransform[2] = { {-0.017303, 0.032567, 0.025281, 1}, {0.317609, 0.528344 , 0.213134 , 0.757991} };
				m_boneTransform[3] = { {0.040406, 0.000000, -0.000000, 1}, {0.991742, 0.085317 , 0.019416 , 0.093765} };
				m_boneTransform[4] = { {0.032517, -0.000000, 0.000000, 1}, {0.959385, -0.012202 , -0.031055 , 0.280120} };
			}
			else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_X_TOUCH)) != 0) {
				//x touch
				m_boneTransform[2] = { {-0.017625, 0.031098, 0.022755, 1}, {0.388513, 0.527438 , 0.249444 , 0.713193} };
				m_boneTransform[3] = { {0.040406, 0.000000, -0.000000, 1}, {0.978341, 0.085924 , 0.037765 , 0.184501} };
				m_boneTransform[4] = { {0.032517, -0.000000, 0.000000, 1}, {0.894037, -0.043820 , -0.048328 , 0.443217} };
			}
			else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_JOYSTICK_TOUCH)) != 0) {
				//joy
				m_boneTransform[2] = { {-0.017914, 0.029178, 0.025298, 1}, {0.455126, 0.591760 , 0.168152 , 0.643743} };
				m_boneTransform[3] = { {0.040406, 0.000000, -0.000000, 1}, {0.969878, 0.084444 , 0.045679 , 0.223873} };
				m_boneTransform[4] = { {0.032517, -0.000000, 0.000000, 1}, {0.991257, 0.014384 , -0.005602 , 0.131040} };
			}



			//trigger touch, no grp
			if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_TOUCH)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_CLICK)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_GRIP_CLICK)) != 0) {
				m_boneTransform[6] = { {-0.003925, 0.027171, 0.014640, 1}, {0.666448, 0.430031 , -0.455947 , 0.403772} };
				m_boneTransform[7] = { {0.074204, -0.005002, 0.000234, 1}, {-0.951843, 0.009717 , 0.158611 , -0.262188} };
				m_boneTransform[8] = { {0.043930, -0.000000, -0.000000, 1}, {-0.973045, -0.044676 , 0.010341 , -0.226012} };
				m_boneTransform[9] = { {0.028695, 0.000000, 0.000000, 1}, {-0.935253, -0.002881 , 0.023037 , -0.353217} };
				m_boneTransform[10] = { {0.022821, 0.000000, -0.000000, 1}, {1.000000, -0.000000 , -0.000000 , 0.000000} };
				m_boneTransform[11] = { {0.002177, 0.007120, 0.016319, 1}, {0.529359, 0.540512 , -0.463783 , 0.461011} };
				m_boneTransform[12] = { {0.070953, 0.000779, 0.000997, 1}, {0.847397, -0.257141 , -0.139135 , 0.443213} };
				m_boneTransform[13] = { {0.043108, 0.000000, 0.000000, 1}, {0.874907, 0.009875 , 0.026584 , 0.483460} };
				m_boneTransform[14] = { {0.033266, -0.000000, 0.000000, 1}, {0.894578, -0.036774 , -0.050597 , 0.442513} };
				m_boneTransform[15] = { {0.025892, -0.000000, 0.000000, 1}, {0.999195, -0.000000 , 0.000000 , 0.040126} };
				m_boneTransform[16] = { {0.000513, -0.006545, 0.016348, 1}, {0.500244, 0.530784 , -0.516215 , 0.448939} };
				m_boneTransform[17] = { {0.065876, 0.001786, 0.000693, 1}, {0.831617, -0.242931 , -0.139695 , 0.479461} };
				m_boneTransform[18] = { {0.040697, 0.000000, 0.000000, 1}, {0.769163, -0.001746 , 0.001363 , 0.639049} };
				m_boneTransform[19] = { {0.028747, -0.000000, -0.000000, 1}, {0.968615, -0.064538 , -0.046586 , 0.235477} };
				m_boneTransform[20] = { {0.022430, -0.000000, 0.000000, 1}, {1.000000, 0.000000 , -0.000000 , -0.000000} };
				m_boneTransform[21] = { {-0.002478, -0.018981, 0.015214, 1}, {0.474671, 0.434670 , -0.653212 , 0.398827} };
				m_boneTransform[22] = { {0.062878, 0.002844, 0.000332, 1}, {0.798788, -0.199577 , -0.094418 , 0.559636} };
				m_boneTransform[23] = { {0.030220, 0.000002, -0.000000, 1}, {0.853087, 0.001644 , -0.000913 , 0.521765} };
				m_boneTransform[24] = { {0.018187, -0.000002, 0.000000, 1}, {0.974249, 0.052491 , 0.003591 , 0.219249} };
				m_boneTransform[25] = { {0.018018, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , 0.000000 , 0.000000} };
				m_boneTransform[26] = { {0.006629, 0.026690, 0.061870, 1}, {0.805084, -0.018369 , 0.584788 , -0.097597} };
				m_boneTransform[27] = { {-0.009005, -0.041708, 0.037992, 1}, {-0.338860, 0.939952 , -0.007564 , 0.040082} };
				m_boneTransform[28] = { {0.017136, -0.032633, 0.080682, 1}, {-0.169466, 0.800083 , 0.571006 , 0.071415} };
				m_boneTransform[29] = { {0.011144, -0.028727, 0.108366, 1}, {-0.076328, 0.788280 , 0.605097 , 0.081527} };
				m_boneTransform[30] = { {0.011333, -0.026044, 0.128585, 1}, {-0.144791, 0.737451 , 0.656958 , -0.060069} };
			}
			//trigger click, no grp
			else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_CLICK)) != 0 && (c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_TOUCH)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_GRIP_CLICK)) != 0) {
				m_boneTransform[6] = { {-0.003925, 0.027171, 0.014640, 1}, {0.666448, 0.430031 , -0.455947 , 0.403772} };
				m_boneTransform[7] = { {0.076015, -0.005124, 0.000239, 1}, {-0.956011, -0.000025 , 0.158355 , -0.246913} };
				m_boneTransform[8] = { {0.043930, -0.000000, -0.000000, 1}, {-0.944138, -0.043351 , 0.014947 , -0.326345} };
				m_boneTransform[9] = { {0.028695, 0.000000, 0.000000, 1}, {-0.912149, 0.003626 , 0.039888 , -0.407898} };
				m_boneTransform[10] = { {0.022821, 0.000000, -0.000000, 1}, {1.000000, -0.000000 , -0.000000 , 0.000000} };
				m_boneTransform[11] = { {0.002177, 0.007120, 0.016319, 1}, {0.529359, 0.540512 , -0.463783 , 0.461011} };
				m_boneTransform[12] = { {0.070953, 0.000779, 0.000997, 1}, {0.847397, -0.257141 , -0.139135 , 0.443213} };
				m_boneTransform[13] = { {0.043108, 0.000000, 0.000000, 1}, {0.874907, 0.009875 , 0.026584 , 0.483460} };
				...
				m_boneTransform[25] = { {0.018018, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , 0.000000 , 0.000000} };
				m_boneTransform[26] = { {0.006629, 0.026690, 0.061870, 1}, {0.805084, -0.018369 , 0.584788 , -0.097597} };
				m_boneTransform[27] = { {-0.007882, -0.040478, 0.039337, 1}, {-0.322494, 0.932092 , 0.121861 , 0.111140} };
				m_boneTransform[28] = { {0.017136, -0.032633, 0.080682, 1}, {-0.169466, 0.800083 , 0.571006 , 0.071415} };
				m_boneTransform[29] = { {0.011144, -0.028727, 0.108366, 1}, {-0.076328, 0.788280 , 0.605097 , 0.081527} };
				m_boneTransform[30] = { {0.011333, -0.026044, 0.128585, 1}, {-0.144791, 0.737451 , 0.656958 , -0.060069} };
			}
			//grip click, no trigger
			else if (!(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_TOUCH)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_CLICK)) != 0 && (c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_GRIP_CLICK)) != 0) {
				m_boneTransform[6] = { {-0.003925, 0.027171, 0.014640, 1}, {0.666448, 0.430031 , -0.455947 , 0.403772} };
				m_boneTransform[7] = { {0.075827, -0.005112, 0.000239, 1}, {-0.982099, -0.015772 , 0.102744 , -0.157085} };
				m_boneTransform[8] = { {0.044111, -0.000000, -0.000000, 1}, {-0.998948, -0.045859 , -0.000005 , 0.000000} };
				m_boneTransform[9] = { {0.028814, 0.000000, 0.000000, 1}, {-0.999419, 0.001622 , 0.003835 , -0.033834} };
				m_boneTransform[10] = { {0.022821, 0.000000, -0.000000, 1}, {1.000000, -0.000000 , -0.000000 , 0.000000} };
				m_boneTransform[11] = { {0.002177, 0.007120, 0.016319, 1}, {0.529359, 0.540512 , -0.463783 , 0.461011} };
				m_boneTransform[12] = { {0.070953, 0.000779, 0.000997, 1}, {-0.831727, 0.270927 , 0.175647 , -0.451638} };
				m_boneTransform[13] = { {0.043108, 0.000000, 0.000000, 1}, {-0.854886, -0.008231 , -0.028107 , -0.517990} };
				m_boneTransform[14] = { {0.033266, -0.000000, 0.000000, 1}, {-0.825759, 0.085208 , 0.086456 , -0.550805} };
				m_boneTransform[15] = { {0.025892, -0.000000, 0.000000, 1}, {0.999195, -0.000000 , 0.000000 , 0.040126} };
				m_boneTransform[16] = { {0.000513, -0.006545, 0.016348, 1}, {0.500244, 0.530784 , -0.516215 , 0.448939} };
				m_boneTransform[17] = { {0.065876, 0.001786, 0.000693, 1}, {0.831617, -0.242931 , -0.139695 , 0.479461} };
				m_boneTransform[18] = { {0.040697, 0.000000, 0.000000, 1}, {0.769163, -0.001746 , 0.001363 , 0.639049} };
				m_boneTransform[19] = { {0.028747, -0.000000, -0.000000, 1}, {0.968615, -0.064537 , -0.046586 , 0.235477} };
				m_boneTransform[20] = { {0.022430, -0.000000, 0.000000, 1}, {1.000000, 0.000000 , -0.000000 , -0.000000} };
				m_boneTransform[21] = { {-0.002478, -0.018981, 0.015214, 1}, {0.474671, 0.434670 , -0.653212 , 0.398827} };
				m_boneTransform[22] = { {0.062878, 0.002844, 0.000332, 1}, {0.798788, -0.199577 , -0.094418 , 0.559636} };
				m_boneTransform[23] = { {0.030220, 0.000002, -0.000000, 1}, {0.853087, 0.001644 , -0.000913 , 0.521765} };
				...
				m_boneTransform[25] = { {0.018018, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , 0.000000 , 0.000000} };
				m_boneTransform[26] = { {0.006629, 0.026690, 0.061870, 1}, {0.805084, -0.018369 , 0.584788 , -0.097597} };
				m_boneTransform[27] = { {-0.023642, -0.048789, 0.024434, 1}, {-0.326935, 0.743115 , -0.550025 , -0.195873} };
				m_boneTransform[28] = { {0.016642, -0.029992, 0.083200, 1}, {-0.094577, 0.694550 , 0.702845 , 0.121100} };
				m_boneTransform[29] = { {0.011144, -0.028727, 0.108366, 1}, {-0.076328, 0.788280 , 0.605097 , 0.081527} };
				m_boneTransform[30] = { {0.011333, -0.026044, 0.128585, 1}, {-0.144791, 0.737451 , 0.656958 , -0.060069} };
			}
			//grip click, trigger touch
			else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_TOUCH)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_CLICK)) != 0 && (c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_GRIP_CLICK)) != 0) {
		...
		//without controller
			...
			//y touch
			if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_Y_TOUCH)) != 0) {
				m_boneTransform[2] = { {-0.016426, 0.030866, 0.025118, 1}, {0.403850, 0.595704 , 0.082451 , 0.689380} };
				m_boneTransform[3] = { {0.040406, 0.000000, -0.000000, 1}, {0.989655, -0.090426 , 0.028457 , 0.107691} };
				m_boneTransform[4] = { {0.032517, 0.000000, 0.000000, 1}, {0.988590, 0.143978 , 0.041520 , 0.015363} };
			}
			else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_X_TOUCH)) != 0) {
				//x touch
				m_boneTransform[2] = { {-0.017288, 0.027151, 0.021465, 1}, {0.502777, 0.569978 , 0.147197 , 0.632988} };
				m_boneTransform[3] = { {0.040406, 0.000000, -0.000000, 1}, {0.970397, -0.048119 , 0.023261 , 0.235527} };
				m_boneTransform[4] = { {0.032517, 0.000000, 0.000000, 1}, {0.794064, 0.084451 , -0.037468 , 0.600772} };
			}
			else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_JOYSTICK_TOUCH)) != 0) {
				//joy
				m_boneTransform[2] = { {-0.017914, 0.029178, 0.025298, 1}, {0.455126, 0.591760 , 0.168152 , 0.643743} };
			...
			//trigger touch, no grp
			if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_TOUCH)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_CLICK)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_GRIP_CLICK)) != 0) {
				m_boneTransform[6] = { {0.002693, 0.023387, 0.013573, 1}, {0.626743, 0.404630 , -0.499840 , 0.440032} };
				m_boneTransform[7] = { {0.074204, -0.005002, 0.000234, 1}, {0.869067, -0.019031 , -0.093524 , 0.485400} };
				m_boneTransform[8] = { {0.043512, -0.000000, -0.000000, 1}, {0.834068, 0.020722 , 0.003930 , 0.551259} };
				m_boneTransform[9] = { {0.028422, 0.000000, 0.000000, 1}, {0.890556, 0.000289 , -0.009290 , 0.454779} };
				m_boneTransform[10] = { {0.022821, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , -0.000000 , 0.000000} };
				m_boneTransform[11] = { {0.003937, 0.006967, 0.016424, 1}, {0.531603, 0.532690 , -0.459598 , 0.471602} };
				m_boneTransform[12] = { {0.070953, 0.000779, 0.000997, 1}, {0.906933, -0.142169 , -0.015445 , 0.396261} };
				m_boneTransform[13] = { {0.043108, 0.000000, 0.000000, 1}, {0.975787, 0.014996 , 0.010867 , 0.217936} };
				m_boneTransform[14] = { {0.033266, 0.000000, 0.000000, 1}, {0.992777, -0.002096 , -0.021403 , 0.118029} };
				m_boneTransform[15] = { {0.025892, -0.000000, 0.000000, 1}, {0.999195, 0.000000 , 0.000000 , 0.040126} };
				m_boneTransform[16] = { {0.001282, -0.006612, 0.016394, 1}, {0.513688, 0.543325 , -0.502550 , 0.434011} };
				m_boneTransform[17] = { {0.065876, 0.001786, 0.000693, 1}, {0.971280, -0.068108 , -0.073480 , 0.215818} };
				m_boneTransform[18] = { {0.040619, 0.000000, 0.000000, 1}, {0.976566, -0.001379 , 0.000441 , 0.215216} };
				m_boneTransform[19] = { {0.028715, -0.000000, -0.000000, 1}, {0.987232, -0.000977 , -0.011919 , 0.158838} };
				m_boneTransform[20] = { {0.022430, -0.000000, 0.000000, 1}, {1.000000, 0.000000 , 0.000000 , 0.000000} };
				m_boneTransform[21] = { {-0.002032, -0.019020, 0.015240, 1}, {0.521784, 0.511917 , -0.594340 , 0.335325} };
				m_boneTransform[22] = { {0.062878, 0.002844, 0.000332, 1}, {0.982925, -0.053050 , -0.108004 , 0.139206} };
				m_boneTransform[23] = { {0.030177, 0.000000, 0.000000, 1}, {0.979798, 0.000394 , -0.001374 , 0.199982} };
				m_boneTransform[24] = { {0.018187, 0.000000, 0.000000, 1}, {0.997410, -0.000172 , -0.051977 , -0.049724} };
				m_boneTransform[25] = { {0.018018, 0.000000, -0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
				m_boneTransform[26] = { {-0.004857, 0.053377, 0.060017, 1}, {0.751040, 0.174397 , 0.601473 , 0.209178} };
				m_boneTransform[27] = { {-0.013234, -0.004327, 0.069740, 1}, {-0.119277, 0.262590 , -0.888979 , -0.355718} };
				m_boneTransform[28] = { {-0.037500, -0.074514, 0.046899, 1}, {-0.204942, 0.706005 , -0.626220 , -0.259623} };
				m_boneTransform[29] = { {-0.036251, -0.089302, 0.081732, 1}, {-0.194045, 0.764033 , -0.596592 , -0.150590} };
				m_boneTransform[30] = { {-0.029633, -0.085595, 0.119439, 1}, {-0.025015, 0.787219 , -0.601140 , -0.135243} };
			}
			//trigger click, no grp
			else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_CLICK)) != 0 && (c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_TOUCH)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_GRIP_CLICK)) != 0) {
				m_boneTransform[6] = { {0.003802, 0.021514, 0.012803, 1}, {0.617314, 0.395175 , -0.510874 , 0.449185} };
				m_boneTransform[7] = { {0.074204, -0.005002, 0.000234, 1}, {0.737291, -0.032006 , -0.115013 , 0.664944} };
				m_boneTransform[8] = { {0.043287, -0.000000, -0.000000, 1}, {0.611381, 0.003287 , 0.003823 , 0.791320} };
				m_boneTransform[9] = { {0.028275, 0.000000, 0.000000, 1}, {0.745389, -0.000684 , -0.000945 , 0.666629} };
				m_boneTransform[10] = { {0.022821, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , -0.000000 , 0.000000} };
				m_boneTransform[11] = { {0.004885, 0.006885, 0.016480, 1}, {0.522678, 0.527374 , -0.469333 , 0.477923} };
				m_boneTransform[12] = { {0.070953, 0.000779, 0.000997, 1}, {0.826071, -0.121321 , 0.017267 , 0.550082} };
				m_boneTransform[13] = { {0.043108, 0.000000, 0.000000, 1}, {0.956676, 0.013210 , 0.009330 , 0.290704} };
				m_boneTransform[14] = { {0.033266, 0.000000, 0.000000, 1}, {0.979740, -0.001605 , -0.019412 , 0.199323} };
				m_boneTransform[15] = { {0.025892, -0.000000, 0.000000, 1}, {0.999195, 0.000000 , 0.000000 , 0.040126} };
				m_boneTransform[16] = { {0.001696, -0.006648, 0.016418, 1}, {0.509620, 0.540794 , -0.504891 , 0.439220} };
				m_boneTransform[17] = { {0.065876, 0.001786, 0.000693, 1}, {0.955009, -0.065344 , -0.063228 , 0.282294} };
				m_boneTransform[18] = { {0.040577, 0.000000, 0.000000, 1}, {0.953823, -0.000972 , 0.000697 , 0.300366} };
				m_boneTransform[19] = { {0.028698, -0.000000, -0.000000, 1}, {0.977627, -0.001163 , -0.011433 , 0.210033} };
				m_boneTransform[20] = { {0.022430, -0.000000, 0.000000, 1}, {1.000000, 0.000000 , 0.000000 , 0.000000} };
				m_boneTransform[21] = { {-0.001792, -0.019041, 0.015254, 1}, {0.518602, 0.511152 , -0.596086 , 0.338315} };
				m_boneTransform[22] = { {0.062878, 0.002844, 0.000332, 1}, {0.978584, -0.045398 , -0.103083 , 0.172297} };
				m_boneTransform[23] = { {0.030154, 0.000000, 0.000000, 1}, {0.970479, -0.000068 , -0.002025 , 0.241175} };
				m_boneTransform[24] = { {0.018187, 0.000000, 0.000000, 1}, {0.997053, -0.000687 , -0.052009 , -0.056395} };
				m_boneTransform[25] = { {0.018018, 0.000000, -0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
				m_boneTransform[26] = { {-0.005193, 0.054191, 0.060030, 1}, {0.747374, 0.182388 , 0.599615 , 0.220518} };
				m_boneTransform[27] = { {0.000171, 0.016473, 0.096515, 1}, {-0.006456, 0.022747 , -0.932927 , -0.359287} };
				m_boneTransform[28] = { {-0.038019, -0.074839, 0.046941, 1}, {-0.199973, 0.698334 , -0.635627 , -0.261380} };
				m_boneTransform[29] = { {-0.036836, -0.089774, 0.081969, 1}, {-0.191006, 0.756582 , -0.607429 , -0.148761} };
				m_boneTransform[30] = { {-0.030241, -0.086049, 0.119881, 1}, {-0.019037, 0.779368 , -0.612017 , -0.132881} };
			}
			//grip click, no trigger
			else if (!(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_TOUCH)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_CLICK)) != 0 && (c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_GRIP_CLICK)) != 0) {
				m_boneTransform[6] = { {0.000632, 0.026866, 0.015002, 1}, {0.644251, 0.421979 , -0.478202 , 0.422133} };
				...
				m_boneTransform[9] = { {0.028695, 0.000000, 0.000000, 1}, {0.999649, 0.001850 , -0.022782 , -0.013409} };
				m_boneTransform[10] = { {0.022821, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , -0.000000 , 0.000000} };
				m_boneTransform[11] = { {0.005787, 0.006806, 0.016534, 1}, {0.514203, 0.522315 , -0.478348 , 0.483700} };
				m_boneTransform[12] = { {0.070953, 0.000779, 0.000997, 1}, {0.723653, -0.097901 , 0.048546 , 0.681458} };
				m_boneTransform[13] = { {0.043108, 0.000000, 0.000000, 1}, {0.637464, -0.002366 , -0.002831 , 0.770472} };
				m_boneTransform[14] = { {0.033266, 0.000000, 0.000000, 1}, {0.658008, 0.002610 , 0.003196 , 0.753000} };
				m_boneTransform[15] = { {0.025892, -0.000000, 0.000000, 1}, {0.999195, 0.000000 , 0.000000 , 0.040126} };
				m_boneTransform[16] = { {0.004123, -0.006858, 0.016563, 1}, {0.489609, 0.523374 , -0.520644 , 0.463997} };
				m_boneTransform[17] = { {0.065876, 0.001786, 0.000693, 1}, {0.759970, -0.055609 , 0.011571 , 0.647471} };
				m_boneTransform[18] = { {0.040331, 0.000000, 0.000000, 1}, {0.664315, 0.001595 , 0.001967 , 0.747449} };
				m_boneTransform[19] = { {0.028489, -0.000000, -0.000000, 1}, {0.626957, -0.002784 , -0.003234 , 0.779042} };
				m_boneTransform[20] = { {0.022430, -0.000000, 0.000000, 1}, {1.000000, 0.000000 , 0.000000 , 0.000000} };
				m_boneTransform[21] = { {0.001131, -0.019295, 0.015429, 1}, {0.479766, 0.477833 , -0.630198 , 0.379934} };
				m_boneTransform[22] = { {0.062878, 0.002844, 0.000332, 1}, {0.827001, 0.034282 , 0.003440 , 0.561144} };
				m_boneTransform[23] = { {0.029874, 0.000000, 0.000000, 1}, {0.702185, -0.006716 , -0.009289 , 0.711903} };
				m_boneTransform[24] = { {0.017979, 0.000000, 0.000000, 1}, {0.676853, 0.007956 , 0.009917 , 0.736009} };
				m_boneTransform[25] = { {0.018018, 0.000000, -0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
				m_boneTransform[26] = { {-0.005550, 0.055054, 0.060044, 1}, {0.743323, 0.190806 , 0.597512 , 0.232472} };
				m_boneTransform[27] = { {-0.040416, -0.043018, 0.019345, 1}, {-0.290331, 0.623527 , -0.663809 , -0.293734} };
				m_boneTransform[28] = { {0.000448, 0.001536, 0.116543, 1}, {-0.039357, 0.105143 , -0.928833 , -0.353079} };
				m_boneTransform[29] = { {0.003949, -0.014869, 0.130608, 1}, {-0.055071, 0.068695 , -0.944016 , -0.317933} };
				m_boneTransform[30] = { {0.003263, -0.034685, 0.139926, 1}, {0.019690, -0.100741 , -0.957331 , -0.270149} };
			}
			//grip click, trigger touch
			else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_TOUCH)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_CLICK)) != 0 && (c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_GRIP_CLICK)) != 0) {
				m_boneTransform[6] = { {0.002693, 0.023387, 0.013573, 1}, {0.626975, 0.404706 , -0.499622 , 0.439878} };
				m_boneTransform[7] = { {0.074204, -0.005002, 0.000234, 1}, {0.870373, -0.019072 , -0.092496 , 0.483251} };
				m_boneTransform[8] = { {0.043512, -0.000000, -0.000000, 1}, {0.837607, 0.020779 , 0.003589 , 0.545866} };
				m_boneTransform[9] = { {0.028422, 0.000000, 0.000000, 1}, {0.891693, 0.000234 , -0.009309 , 0.452545} };
				m_boneTransform[10] = { {0.022821, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , -0.000000 , 0.000000} };
				m_boneTransform[11] = { {0.005787, 0.006806, 0.016534, 1}, {0.514203, 0.522315 , -0.478348 , 0.483700} };
				m_boneTransform[12] = { {0.070953, 0.000779, 0.000997, 1}, {0.723653, -0.097901 , 0.048546 , 0.681458} };
				m_boneTransform[13] = { {0.043108, 0.000000, 0.000000, 1}, {0.637464, -0.002366 , -0.002831 , 0.770472} };
				...
				m_boneTransform[24] = { {0.017979, 0.000000, 0.000000, 1}, {0.676853, 0.007956 , 0.009917 , 0.736009} };
				m_boneTransform[25] = { {0.018018, 0.000000, -0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
				m_boneTransform[26] = { {-0.005725, 0.055476, 0.060051, 1}, {0.741276, 0.194911 , 0.596431 , 0.238304} };
				m_boneTransform[27] = { {-0.014034, -0.004349, 0.069506, 1}, {-0.114615, 0.252243 , -0.891720 , -0.357873} };
				m_boneTransform[28] = { {0.000448, 0.001536, 0.116543, 1}, {-0.039357, 0.105143 , -0.928833 , -0.353079} };
				m_boneTransform[29] = { {0.003949, -0.014869, 0.130608, 1}, {-0.055071, 0.068695 , -0.944016 , -0.317933} };
				m_boneTransform[30] = { {0.003263, -0.034685, 0.139926, 1}, {0.019690, -0.100741 , -0.957331 , -0.270149} };
			...
			//grip click, trigger touch
				...
				m_boneTransform[24] = { {0.017979, 0.000000, 0.000000, 1}, {0.676853, 0.007956 , 0.009917 , 0.736009} };
				m_boneTransform[25] = { {0.018018, 0.000000, -0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
				m_boneTransform[26] = { {-0.005769, 0.055583, 0.060053, 1}, {0.740753, 0.195947 , 0.596153 , 0.239776} };
				m_boneTransform[27] = { {0.000171, 0.016473, 0.096515, 1}, {-0.006456, 0.022747 , -0.932927 , -0.359287} };
				m_boneTransform[28] = { {0.000448, 0.001536, 0.116543, 1}, {-0.039357, 0.105143 , -0.928833 , -0.353079} };
				m_boneTransform[29] = { {0.003949, -0.014869, 0.130608, 1}, {-0.055071, 0.068695 , -0.944016 , -0.317933} };
				m_boneTransform[30] = { {0.003263, -0.034685, 0.139926, 1}, {0.019690, -0.100741 , -0.957331 , -0.270149} };
		...
		//right hand
		 ...
		 m_boneTransform[0] = { {0.000000, 0.000000, 0.000000, 1}, {1.000000, -0.000000 , -0.000000 , 0.000000} };
		 m_boneTransform[1] = { {0.034038, 0.036503, 0.164722, 1}, {-0.055147, -0.078608 , 0.920279 , -0.379296} };
		 m_boneTransform[2] = { {0.012330, 0.028661, 0.025049, 1}, {0.571059, -0.451277 , 0.630056 , -0.270685} };
		 m_boneTransform[3] = { {-0.040406, -0.000000, 0.000000, 1}, {0.994565, 0.078280 , 0.018282 , 0.066177} };
		 m_boneTransform[4] = { {-0.032517, -0.000000, -0.000000, 1}, {0.977658, -0.003039 , 0.020722 , -0.209156} };
		 m_boneTransform[5] = { {-0.030464, 0.000000, 0.000000, 1}, {1.000000, -0.000000 , 0.000000 , 0.000000} };
		 m_boneTransform[6] = { {-0.000632, 0.026866, 0.015002, 1}, {0.421833, -0.643793 , 0.422458 , 0.478661} };
		 m_boneTransform[7] = { {-0.074204, 0.005002, -0.000234, 1}, {0.994784, 0.007053 , -0.041286 , 0.093009} };
		 m_boneTransform[8] = { {-0.043930, 0.000000, 0.000000, 1}, {0.998404, 0.045905 , 0.002780 , -0.032767} };
		 m_boneTransform[9] = { {-0.028695, -0.000000, -0.000000, 1}, {0.999704, 0.001955 , -0.022774 , -0.008282} };
		 m_boneTransform[10] = { {-0.022821, -0.000000, 0.000000, 1}, {1.000000, 0.000000 , -0.000000 , 0.000000} };
		 m_boneTransform[11] = { {-0.002177, 0.007120, 0.016319, 1}, {0.541874, -0.547427 , 0.459996 , 0.441701} };
		 m_boneTransform[12] = { {-0.070953, -0.000779, -0.000997, 1}, {0.979837, -0.168061 , -0.075910 , 0.076899} };
		 m_boneTransform[13] = { {-0.043108, -0.000000, -0.000000, 1}, {0.997271, 0.018278 , 0.013375 , 0.070266} };
		 m_boneTransform[14] = { {-0.033266, -0.000000, -0.000000, 1}, {0.998402, -0.003143 , -0.026423 , -0.049849} };
		 m_boneTransform[15] = { {-0.025892, 0.000000, -0.000000, 1}, {0.999195, 0.000000 , 0.000000 , 0.040126} };
		 m_boneTransform[16] = { {-0.000513, -0.006545, 0.016348, 1}, {0.548983, -0.519068 , 0.426914 , 0.496920} };
		 m_boneTransform[17] = { {-0.065876, -0.001786, -0.000693, 1}, {0.989791, -0.065882 , -0.096417 , 0.081716} };
		 m_boneTransform[18] = { {-0.040697, -0.000000, -0.000000, 1}, {0.999102, -0.002168 , -0.000020 , 0.042317} };
		 m_boneTransform[19] = { {-0.028747, 0.000000, 0.000000, 1}, {0.998584, -0.000674 , -0.012714 , 0.051653} };
		 m_boneTransform[20] = { {-0.022430, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , 0.000000 , 0.000000} };
		 m_boneTransform[21] = { {0.002478, -0.018981, 0.015214, 1}, {0.518597, -0.527304 , 0.328264 , 0.587580} };
		 m_boneTransform[22] = { {-0.062878, -0.002844, -0.000332, 1}, {0.987294, -0.063356 , -0.125964 , 0.073274} };
		 m_boneTransform[23] = { {-0.030220, -0.000000, -0.000000, 1}, {0.993413, 0.001573 , -0.000147 , 0.114578} };
		 m_boneTransform[24] = { {-0.018187, -0.000000, -0.000000, 1}, {0.997047, -0.000695 , -0.052009 , -0.056495} };
		 m_boneTransform[25] = { {-0.018018, -0.000000, 0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
		 m_boneTransform[26] = { {0.005198, 0.054204, 0.060030, 1}, {0.747318, 0.182508 , -0.599586 , -0.220688} };
		 m_boneTransform[27] = { {0.038779, -0.042973, 0.019824, 1}, {-0.297445, 0.639373 , 0.648910 , 0.285734} };
		 m_boneTransform[28] = { {0.038027, -0.074844, 0.046941, 1}, {-0.199898, 0.698218 , 0.635767 , 0.261406} };
		 m_boneTransform[29] = { {0.036845, -0.089781, 0.081973, 1}, {-0.190960, 0.756469 , 0.607591 , 0.148733} };
		 m_boneTransform[30] = { {0.030251, -0.086056, 0.119887, 1}, {-0.018948, 0.779249 , 0.612180 , 0.132846} };
		 ...
		 if (withController) {
			 //y touch
			 if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_B_TOUCH)) != 0) {	

				 m_boneTransform[2] = { {0.017303, 0.032567, 0.025281, 1}, {0.528344, -0.317609 , 0.757991 , -0.213134} };
				 m_boneTransform[3] = { {-0.040406, -0.000000, 0.000000, 1}, {0.991742, 0.085317 , 0.019416 , 0.093765} };
				 m_boneTransform[4] = { {-0.032517, 0.000000, -0.000000, 1}, {0.959385, -0.012202 , -0.031055 , 0.280120} };
			 }
			 else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_A_TOUCH)) != 0) {
				 //x touch
				 m_boneTransform[2] = { {0.017625, 0.031098, 0.022755, 1}, {0.527438, -0.388513 , 0.713193 , -0.249444} };
				 m_boneTransform[3] = { {-0.040406, -0.000000, 0.000000, 1}, {0.978341, 0.085924 , 0.037765 , 0.184501} };
				 m_boneTransform[4] = { {-0.032517, 0.000000, -0.000000, 1}, {0.894037, -0.043820 , -0.048328 , 0.443217} };
			 }
			 else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_JOYSTICK_TOUCH)) != 0) {
				 //joy
				 m_boneTransform[2] = { {0.017914, 0.029178, 0.025298, 1}, {0.591760, -0.455126 , 0.643743 , -0.168152} };
				 m_boneTransform[3] = { {-0.040406, -0.000000, 0.000000, 1}, {0.969878, 0.084444 , 0.045679 , 0.223873} };
				 m_boneTransform[4] = { {-0.032517, 0.000000, -0.000000, 1}, {0.991257, 0.014384 , -0.005602 , 0.131040} };
			 }
			 ////
		 ...
		 //thumb
			 ...
			 //y touch
			 if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_B_TOUCH)) != 0) {
				 m_boneTransform[2] = { {0.016426, 0.030866, 0.025118, 1}, {0.595704, -0.403850 , 0.689380 , -0.082451} };
				 m_boneTransform[3] = { {-0.040406, -0.000000, 0.000000, 1}, {0.989655, -0.090426 , 0.028457 , 0.107691} };
				 m_boneTransform[4] = { {-0.032517, -0.000000, -0.000000, 1}, {0.988590, 0.143978 , 0.041520 , 0.015363} };
			 }
			 else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_A_TOUCH)) != 0) {
				 //x touch
				 m_boneTransform[2] = { {0.017288, 0.027151, 0.021465, 1}, {0.569978, -0.502777 , 0.632988 , -0.147197} };
				 m_boneTransform[3] = { {-0.040406, -0.000000, 0.000000, 1}, {0.970397, -0.048119 , 0.023261 , 0.235527} };
				 m_boneTransform[4] = { {-0.032517, -0.000000, -0.000000, 1}, {0.794064, 0.084451 , -0.037468 , 0.600772} };
			 }
			 else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_JOYSTICK_TOUCH)) != 0) {
			 ...
			 //trigger touch, no grp
			 if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_TOUCH)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_CLICK)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_GRIP_CLICK)) != 0) {
				 m_boneTransform[6] = { {-0.002693, 0.023387, 0.013573, 1}, {0.404698, -0.626951 , 0.439894 , 0.499645} };
				 m_boneTransform[7] = { {-0.074204, 0.005002, -0.000234, 1}, {0.870303, -0.017421 , -0.092515 , 0.483436} };
				 m_boneTransform[8] = { {-0.043512, 0.000000, 0.000000, 1}, {0.835972, 0.018944 , 0.003312 , 0.548436} };
				 m_boneTransform[9] = { {-0.028422, -0.000000, -0.000000, 1}, {0.890326, 0.000173 , -0.008504 , 0.455244} };
				 m_boneTransform[10] = { {-0.022821, -0.000000, 0.000000, 1}, {1.000000, 0.000000 , -0.000000 , 0.000000} };
				 m_boneTransform[11] = { {-0.003937, 0.006967, 0.016424, 1}, {0.532293, -0.531137 , 0.472074 , 0.460113} };
				 m_boneTransform[12] = { {-0.070953, -0.000779, -0.000997, 1}, {0.908154, -0.139967 , -0.013210 , 0.394323} };
				 m_boneTransform[13] = { {-0.043108, -0.000000, -0.000000, 1}, {0.977887, 0.015350 , 0.008912 , 0.208378} };
				 m_boneTransform[14] = { {-0.033266, -0.000000, -0.000000, 1}, {0.992487, -0.002006 , -0.020888 , 0.120540} };
				 m_boneTransform[15] = { {-0.025892, 0.000000, -0.000000, 1}, {0.999195, 0.000000 , 0.000000 , 0.040126} };
				 m_boneTransform[16] = { {-0.001282, -0.006612, 0.016394, 1}, {0.544460, -0.511334 , 0.436935 , 0.501187} };
				 m_boneTransform[17] = { {-0.065876, -0.001786, -0.000693, 1}, {0.971233, -0.064561 , -0.071188 , 0.217877} };
				 m_boneTransform[18] = { {-0.040619, -0.000000, -0.000000, 1}, {0.978211, -0.001419 , 0.000451 , 0.207607} };
				 m_boneTransform[19] = { {-0.028715, 0.000000, 0.000000, 1}, {0.987488, -0.001166 , -0.010852 , 0.157314} };
				 m_boneTransform[20] = { {-0.022430, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , 0.000000 , 0.000000} };
				 m_boneTransform[21] = { {0.002032, -0.019020, 0.015240, 1}, {0.513640, -0.518192 , 0.337332 , 0.594860} };
				 m_boneTransform[22] = { {-0.062878, -0.002844, -0.000332, 1}, {0.983501, -0.050059 , -0.104491 , 0.138930} };
				 m_boneTransform[23] = { {-0.030177, -0.000000, -0.000000, 1}, {0.981170, 0.000501 , -0.001363 , 0.193138} };
				 m_boneTransform[24] = { {-0.018187, -0.000000, -0.000000, 1}, {0.997801, 0.000487 , -0.051933 , -0.041173} };
				 m_boneTransform[25] = { {-0.018018, -0.000000, 0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
				 m_boneTransform[26] = { {0.004574, 0.055518, 0.060226, 1}, {0.745334, 0.161961 , -0.597782 , -0.246784} };
				 m_boneTransform[27] = { {0.013831, -0.004360, 0.069547, 1}, {-0.117443, 0.257604 , 0.890065 , 0.357255} };
				 m_boneTransform[28] = { {0.038220, -0.074817, 0.046428, 1}, {-0.205767, 0.697939 , 0.635107 , 0.259191} };
				 m_boneTransform[29] = { {0.035802, -0.089658, 0.081733, 1}, {-0.196007, 0.758396 , 0.604341 , 0.145564} };
				 m_boneTransform[30] = { {0.029364, -0.086069, 0.119701, 1}, {-0.028444, 0.787767 , 0.601616 , 0.129123} };
			 }
			 //trigger click, no grp
			 else if ((c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_CLICK)) != 0 && (c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_TOUCH)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_GRIP_CLICK)) != 0) {
				 m_boneTransform[6] = { {-0.003802, 0.021514, 0.012803, 1}, {0.395174, -0.617314 , 0.449185 , 0.510874} };
				 m_boneTransform[7] = { {-0.074204, 0.005002, -0.000234, 1}, {0.737291, -0.032006 , -0.115013 , 0.664944} };
				 m_boneTransform[8] = { {-0.043287, 0.000000, 0.000000, 1}, {0.611381, 0.003287 , 0.003823 , 0.791320} };
				 m_boneTransform[9] = { {-0.028275, -0.000000, -0.000000, 1}, {0.745389, -0.000684 , -0.000945 , 0.666629} };
				 m_boneTransform[10] = { {-0.022821, -0.000000, 0.000000, 1}, {1.000000, 0.000000 , -0.000000 , 0.000000} };
				 m_boneTransform[11] = { {-0.004885, 0.006885, 0.016480, 1}, {0.527233, -0.522513 , 0.478085 , 0.469510} };
				 m_boneTransform[12] = { {-0.070953, -0.000779, -0.000997, 1}, {0.826317, -0.120120 , 0.019005 , 0.549918} };
				 m_boneTransform[13] = { {-0.043108, -0.000000, -0.000000, 1}, {0.958363, 0.013484 , 0.007380 , 0.285138} };
				 m_boneTransform[14] = { {-0.033266, -0.000000, -0.000000, 1}, {0.977901, -0.001431 , -0.018078 , 0.208279} };
				 m_boneTransform[15] = { {-0.025892, 0.000000, -0.000000, 1}, {0.999195, 0.000000 , 0.000000 , 0.040126} };
				 m_boneTransform[16] = { {-0.001696, -0.006648, 0.016418, 1}, {0.541481, -0.508179 , 0.441001 , 0.504054} };
				 m_boneTransform[17] = { {-0.065876, -0.001786, -0.000693, 1}, {0.953780, -0.064506 , -0.058812 , 0.287548} };
				 m_boneTransform[18] = { {-0.040577, -0.000000, -0.000000, 1}, {0.954761, -0.000983 , 0.000698 , 0.297372} };
				 m_boneTransform[19] = { {-0.028698, 0.000000, 0.000000, 1}, {0.976924, -0.001344 , -0.010281 , 0.213335} };
				 m_boneTransform[20] = { {-0.022430, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , 0.000000 , 0.000000} };
				 m_boneTransform[21] = { {0.001792, -0.019041, 0.015254, 1}, {0.510569, -0.514906 , 0.341115 , 0.598191} };
				 m_boneTransform[22] = { {-0.062878, -0.002844, -0.000332, 1}, {0.979195, -0.043879 , -0.095103 , 0.173800} };
				 m_boneTransform[23] = { {-0.030154, -0.000000, -0.000000, 1}, {0.971387, -0.000102 , -0.002019 , 0.237494} };
				 m_boneTransform[24] = { {-0.018187, -0.000000, -0.000000, 1}, {0.997961, 0.000800 , -0.051911 , -0.037114} };
				 m_boneTransform[25] = { {-0.018018, -0.000000, 0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
				 m_boneTransform[26] = { {0.004392, 0.055515, 0.060253, 1}, {0.745924, 0.156756 , -0.597950 , -0.247953} };
				 m_boneTransform[27] = { {-0.000171, 0.016473, 0.096515, 1}, {-0.006456, 0.022747 , 0.932927 , 0.359287} };
				 m_boneTransform[28] = { {0.038119, -0.074730, 0.046338, 1}, {-0.207931, 0.699835 , 0.632631 , 0.258406} };
				 m_boneTransform[29] = { {0.035492, -0.089519, 0.081636, 1}, {-0.197555, 0.760574 , 0.601098 , 0.145535} };
				 m_boneTransform[30] = { {0.029073, -0.085957, 0.119561, 1}, {-0.031423, 0.791013 , 0.597190 , 0.129133} };
			 }
			 //grip click, no trigger
			 else if (!(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_TOUCH)) != 0 && !(c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_TRIGGER_CLICK)) != 0 && (c.buttons & ALVR_BUTTON_FLAG(ALVR_INPUT_GRIP_CLICK)) != 0) {
				 m_boneTransform[6] = { {-0.000632, 0.026866, 0.015002, 1}, {0.421979, -0.644251 , 0.422133 , 0.478202} };
				 m_boneTransform[7] = { {-0.074204, 0.005002, -0.000234, 1}, {0.995332, 0.007007 , -0.039124 , 0.087949} };
				 m_boneTransform[8] = { {-0.043930, 0.000000, 0.000000, 1}, {0.997891, 0.045808 , 0.002142 , -0.045943} };
				 m_boneTransform[9] = { {-0.028695, -0.000000, -0.000000, 1}, {0.999649, 0.001850 , -0.022782 , -0.013409} };
				 m_boneTransform[10] = { {-0.022821, -0.000000, 0.000000, 1}, {1.000000, 0.000000 , -0.000000 , 0.000000} };
				 m_boneTransform[11] = { {-0.005787, 0.006806, 0.016534, 1}, {0.522315, -0.514203 , 0.483700 , 0.478348} };
				 m_boneTransform[12] = { {-0.070953, -0.000779, -0.000997, 1}, {0.723653, -0.097901 , 0.048546 , 0.681458} };
				 m_boneTransform[13] = { {-0.043108, -0.000000, -0.000000, 1}, {0.637464, -0.002366 , -0.002831 , 0.770472} };
				 m_boneTransform[14] = { {-0.033266, -0.000000, -0.000000, 1}, {0.658008, 0.002610 , 0.003196 , 0.753000} };
				 m_boneTransform[15] = { {-0.025892, 0.000000, -0.000000, 1}, {0.999195, 0.000000 , 0.000000 , 0.040126} };
				 m_boneTransform[16] = { {-0.004123, -0.006858, 0.016563, 1}, {0.523374, -0.489609 , 0.463997 , 0.520644} };
				 m_boneTransform[17] = { {-0.065876, -0.001786, -0.000693, 1}, {0.759970, -0.055609 , 0.011571 , 0.647471} };
				 m_boneTransform[18] = { {-0.040331, -0.000000, -0.000000, 1}, {0.664315, 0.001595 , 0.001967 , 0.747449} };
				 m_boneTransform[19] = { {-0.028489, 0.000000, 0.000000, 1}, {0.626957, -0.002784 , -0.003234 , 0.779042} };
				 m_boneTransform[20] = { {-0.022430, 0.000000, -0.000000, 1}, {1.000000, 0.000000 , 0.000000 , 0.000000} };
				 m_boneTransform[21] = { {-0.001131, -0.019295, 0.015429, 1}, {0.477833, -0.479766 , 0.379935 , 0.630198} };
				 m_boneTransform[22] = { {-0.062878, -0.002844, -0.000332, 1}, {0.827001, 0.034282 , 0.003440 , 0.561144} };
				 m_boneTransform[23] = { {-0.029874, -0.000000, -0.000000, 1}, {0.702185, -0.006716 , -0.009289 , 0.711903} };
				 m_boneTransform[24] = { {-0.017979, -0.000000, -0.000000, 1}, {0.676853, 0.007956 , 0.009917 , 0.736009} };
				 m_boneTransform[25] = { {-0.018018, -0.000000, 0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
				 m_boneTransform[26] = { {0.003363, 0.054720, 0.060345, 1}, {0.751564, 0.128836 , -0.600239 , -0.241384} };
				 m_boneTransform[27] = { {0.040416, -0.043018, 0.019345, 1}, {-0.290331, 0.623527 , 0.663809 , 0.293734} };
				 m_boneTransform[28] = { {-0.000448, 0.001536, 0.116543, 1}, {-0.039357, 0.105143 , 0.928833 , 0.353079} };
				 m_boneTransform[29] = { {-0.003949, -0.014869, 0.130608, 1}, {-0.055071, 0.068695 , 0.944016 , 0.317933} };
				 m_boneTransform[30] = { {-0.003263, -0.034685, 0.139926, 1}, {0.019690, -0.100741 , 0.957331 , 0.270149} };
			 ...
			 //grip click, trigger touch
				 ...
				 m_boneTransform[6] = { {-0.002693, 0.023387, 0.013573, 1}, {0.404706, -0.626975 , 0.439878 , 0.499622} };
				 m_boneTransform[7] = { {-0.074204, 0.005002, -0.000234, 1}, {0.870373, -0.019072 , -0.092496 , 0.483251} };
				 m_boneTransform[8] = { {-0.043512, 0.000000, 0.000000, 1}, {0.837607, 0.020779 , 0.003589 , 0.545866} };
				 m_boneTransform[9] = { {-0.028422, -0.000000, -0.000000, 1}, {0.891693, 0.000234 , -0.009309 , 0.452545} };
				 m_boneTransform[10] = { {-0.022821, -0.000000, 0.000000, 1}, {1.000000, 0.000000 , -0.000000 , 0.000000} };
				 ...
				 m_boneTransform[24] = { {-0.017979, -0.000000, -0.000000, 1}, {0.676853, 0.007956 , 0.009917 , 0.736009} };
				 m_boneTransform[25] = { {-0.018018, -0.000000, 0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
				 m_boneTransform[26] = { {0.002455, 0.054309, 0.060448, 1}, {0.755030, 0.103540 , -0.601236 , -0.240259} };
				 m_boneTransform[27] = { {0.014034, -0.004349, 0.069506, 1}, {-0.114615, 0.252243 , 0.891720 , 0.357873} };
				 m_boneTransform[28] = { {-0.000448, 0.001536, 0.116543, 1}, {-0.039357, 0.105143 , 0.928833 , 0.353079} };
				 m_boneTransform[29] = { {-0.003949, -0.014869, 0.130608, 1}, {-0.055071, 0.068695 , 0.944016 , 0.317933} };
				 m_boneTransform[30] = { {-0.003263, -0.034685, 0.139926, 1}, {0.019690, -0.100741 , 0.957331 , 0.270149} };
			 ...
			 //grip click, trigger touch
				 ...
				 m_boneTransform[24] = { {-0.017979, -0.000000, -0.000000, 1}, {0.676853, 0.007956 , 0.009917 , 0.736009} };
				 m_boneTransform[25] = { {-0.018018, -0.000000, 0.000000, 1}, {1.000000, -0.000000 , -0.000000 , -0.000000} };
				 m_boneTransform[26] = { {0.002635, 0.054421, 0.060430, 1}, {0.754276, 0.108502 , -0.601005 , -0.241015} };
				 m_boneTransform[27] = { {-0.000171, 0.016473, 0.096515, 1}, {-0.006456, 0.022747 , 0.932927 , 0.359287} };
				 m_boneTransform[28] = { {-0.000448, 0.001536, 0.116543, 1}, {-0.039357, 0.105143 , 0.928833 , 0.353079} };
				 m_boneTransform[29] = { {-0.003949, -0.014869, 0.130608, 1}, {-0.055071, 0.068695 , 0.944016 , 0.317933} };
				 m_boneTransform[30] = { {-0.003263, -0.034685, 0.139926, 1}, {0.019690, -0.100741 , 0.957331 , 0.270149} };
