define({
    ...
    "_root_video_recommendedTargetResolution-choice-.name": "Предпочитана резолюция за изобразяване на играта", // adv
    ...
    "_root_headset_controllers_content_poseTimeOffset.name": "Забавяне на проследяване на позицията", // adv
    "_root_headset_controllers_content_poseTimeOffset.description": "Офсет за алгоритъма за предсказване на позицията.", // adv
