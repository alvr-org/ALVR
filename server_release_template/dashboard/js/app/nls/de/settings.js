define({
    ...
    "_root_video_displayRefreshRate.description": "Bildwiederholrate für das Headset und SteamVR. Höhere Werte benötigen einen besseren PC. 72 Hz ist das Maximum für die Quest 1.",
    ...
    "_root_video_foveatedRendering_content_strength.description": "Ein höherer Wert führt zu weniger Detail am Rand des Bildes, und mehr Artefakten",
    ...
    "_root_video_colorCorrection_content_contrast.description": "Kontrast: -1 bedeutet komplett Grau.",
    ...
    "_root_video_codec-choice-.description": "HEVC wird aufgrund besserer Videoqualität bei niedrigen Datenraten bevorzugt. AMD GPUs funktionieren am besten mit HEVC.",
    ...
    "_root_headset_registeredDeviceType.description": "Registrierter Geräte-Typ des simulierten Headsets", // adv
    "_root_headset_trackingFrameOffset.name": "Tracking Offset",
    "_root_headset_trackingFrameOffset.description": "Tracking Offset für den Positions-Vorhersage-Algorythmus",
    "_root_headset_positionOffset.name": "Headsetpositionsoffset", // adv
    "_root_headset_positionOffset.description": "Headsetpositionsoffset für den Positions-Vorhersage-Algorythmus", // adv
    ...
    "_root_headset_controllers_content_controllerMode.description": "Simuliert verschiedene Controller oder aktiviert Handtracking",
    "_root_headset_controllers_content_modeIdx.name": "Indexmodus", // adv
    "_root_headset_controllers_content_modeIdx.description": "Indexmodus des simulierten Controllers", // adv
    "_root_headset_controllers_content_trackingSystemName.name": "Name des Tracking-Systems", // adv
    "_root_headset_controllers_content_trackingSystemName.description": "Name des simulierten Controllers", // adv
    "_root_headset_controllers_content_manufacturerName.name": "Herstellername", // adv
    "_root_headset_controllers_content_manufacturerName.description": "Herstellername des simulierten Controllers", // adv
    "_root_headset_controllers_content_modelNumber.name": "Modellnummer", // adv
    "_root_headset_controllers_content_modelNumber.description": "Modellnummer des simulierten Controllers", // adv
    "_root_headset_controllers_content_renderModelNameLeft.name": "Modellnummer (linke Hand)", // adv
    "_root_headset_controllers_content_renderModelNameLeft.description": "Modelnummer des linken simulierten Controllers", // adv
    ...
    "_root_headset_controllers_content_rotationOffsetLeft.description": "Rotations Offset für den linken Controller.\nY und Z sind gespiegelt für den rechten Controller", // adv
    ...
    "_root_headset_controllers_content_hapticsIntensity.description": "Faktor zum verstärken/schwächen des Haptischen Feedbacks",
    "_root_headset_trackingSpace-choice-.name": "Trackingzone",
    "_root_headset_trackingSpace-choice-.description": "Definiert die Zone, die das Headset verwendet um zu tracken und die Mitte des Raumes zu definieren. Bühnen-Tracking verhält sich wie ein verkabeltes Headset, und muss verwendet werden wenn Vive-Tracker verwendet werden",
    ...
    "_root_extra_revertConfirmDialog.description": "Nach einer Bestätigung fragen, bevor alle Werte auf den Standard zurückgesetzt werden",
    ...
    "_root_extra_notificationLevel-choice-.description": "Ab welchem Level sollen Benachrichtigungen generiert werden? Von viel zu wenig Benachrichtigungen: \n - Fehler \n - Warnung \n - Information \n - Debug", // adv
    ...
    "_root_extra_excludeNotificationsWithoutId.name": "Benachrichtigungen ohne Identifikationsstruktur auslassen", // adv
    "_root_extra_excludeNotificationsWithoutId.description": "Benachrichtigungen ignorieren, die nicht in die Identifikationsstruktur passen", // adv
    // Others
