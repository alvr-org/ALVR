define({
    ...
    "_root_video_foveatedRendering_content_strength.description": "Los valores más altos corresponden a menos detalles en los bordes de la imagen y más artefactos visuales.",
    ...
    "_root_video_colorCorrection_content_gamma.description": "Gama: Utilizar un valor de 2.2 para corregir el color de sRGB a RGB. Esto controla el brillo pero mantiene a los negros con el negro y a los blancos con el blanco.",
    ...
    "_root_audio_gameAudio_content_device.name": "Código del dispositivo de audio", // adv
    ...
    "_root_audio_microphone_content_device.name": "Código de entrada del micrófono virtual", // adv
    "_root_audio_microphone_content_device.description": "Introduce el código de entrada del micrófono virtual usado para capturar el audio. \nPara que el micrófono funcione correctamente, debe instalar VB-Audio Virtual u otro software equivalente.", // adv
    // Headset tab
    ...
    "_root_headset_trackingSpace-choice-.description": "Establece lo que el visor utiliza como referencia para el seguimiento y cómo se define el centro del espacio. El seguimiento de escenario se comporta como un visor con cable: el centro del espacio se mantiene en un lugar después de haber actualizado el visor. Esto se debe establecer si se desea utilizar el seguimiento de VIVE.",
    ...
    "_root_extra_clientDarkMode.description": "Aplicado después de la conexión y el ciclo sueño-vigilia",
