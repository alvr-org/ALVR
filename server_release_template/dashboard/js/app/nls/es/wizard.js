define({
    ...
    "textHardwareReq": "ALVR requiere una tarjeta gráfica dedicada reciente. <br/> <br/> Asegúrate de tener al menos un dispositivo de salida de audio. <br/> <br/> ",
    ...
    "textImport": "Puedes importar configuracioneso o preconfiguraciones (.json): <ul><li> Preconfiguraciones para un visor específico. Se recomienda que para el visor de <b>Oculus Go</b> (utilizar <code>oculus_go_preset.json</code> de la carpeta de instalación).<li> Ajustes de una instalación previa de ALVR (<code>session.json</code>).<ul>",
    // End page
    "titleFinished": "Listo!",
