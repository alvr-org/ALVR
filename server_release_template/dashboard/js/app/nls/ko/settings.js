define({
    ...
    "_root_video_displayRefreshRate.description": "SteamVr과 헤드셋 재생 속도를 설정합니다. 높은 재생속도는 빠른 PC를 요구합니다. 72 Hz는 퀘스트 1의 최대값입니다.",
    "_root_video_preferredFps.name": "커스텀 재생 속도", // adv
    "_root_video_resolutionDropdown.name": "비디오 해상도",
    "_root_video_resolutionDropdown.description": "100%는 오큘러스의 실제 해상도와 동일합니다. \n해상도를 높이는 것은 품질향상에 도움이 되지만 권장하지 않습니다. \n해상도를 낮추는 것은 지연시간을 줄이고 네트워크 성능에 도움이 됩니다.",
    ...
    "_root_video_secondsFromVsyncToPhotons.description": "이미지가 표시될 때까지 가상 수직 동기화에서 대기하는 시간", // adv
    ...
    "_root_video_foveatedRendering_enabled.description": "GPU 부하를 줄이기 위해 시야 바깥에 있는 이미지의 해상도를 줄이는 렌더링 기술.  네트워크를 통해 전송해야 하는 비디오 해상도가 낮아집니다.",
    "_root_video_foveatedRendering_content_strength.name": "강도",
    "_root_video_foveatedRendering_content_strength.description": "값이 높으면 시야 바깥이 흐려지고 잡음을 유발합니다",
    ...
    "_root_video_foveatedRendering_content_verticalOffset.description": "값이 높으면 고품질 프레임 영역이 아래로 이동됩니다.",
    ...
    "_root_video_colorCorrection_enabled.description": "색상 보정은 다음 순서로 적용됩니다. 선명도, 감마, 밝기, 대비 및 채도입니다.",
    "_root_video_colorCorrection_content_brightness.name": "밝기",
    "_root_video_colorCorrection_content_brightness.description": "밝기: -1은 완전 검은색, 1은 완전 흰색입니다.",
    ...
    "_root_video_colorCorrection_content_gamma.description": "감마: 2.2의 값을 사용하여 sRGB에서 RGB로 색상을 수정합니다. 이것은 밝기를 조절하지만 검은색은 검은색, 흰색은 흰색으로 유지합니다.",
    "_root_video_colorCorrection_content_sharpening.name": "선명도",
    "_root_video_colorCorrection_content_sharpening.description": "선명도: 이미지의 경계를 강조합니다.",
    "_root_video_codec-choice-.name": "비디오 코덱",
    "_root_video_codec-choice-.description": "HEVC은 낮은 비트레이트에서 좋은 품질을 유지합니다. AMD 그래픽카드는 HEVC와 알맞습니다.",
    ...
    "_root_headset_headsetEmulationMode.description": "더 좋은 호환성을 위해 다른 헤드셋을 에뮬레이션합니다.",
    ...
    "_root_headset_controllers_content_trackingSystemName.description": "에뮬레이터 컨트롤러 트래킹 시스템의 이름", // adv
    "_root_headset_controllers_content_manufacturerName.name": "제조사 이름", // adv
    "_root_headset_controllers_content_manufacturerName.description": "에뮬레이터 컨트롤러의 제조사 이름", // adv
    ...
    "_root_headset_controllers_content_renderModelNameLeft.description": "왼손 에뮬레이터 컨트롤러의 모델 숫자", // adv
    ...
    "_root_headset_controllers_content_positionOffsetLeft.description": "왼쪽 컨트롤러의 위치 오프셋(미터)입니다. \n오른쪽 컨트롤러와 x 값이 반대입니다.", // adv
    ...
    "_root_headset_controllers_content_rotationOffsetLeft.description": "왼쪽 컨트롤러의 회전각도 오프셋(도)입니다. \n오른쪽 컨트롤러와  Y Z 축이 반대입니다.", // adv
    ...
    "_root_extra_notificationLevel-choice-.description": "알림이 생성되는 수준입니다. 대략적 정보에서 모든 세부 정보까지: \n- Error \n- Warning \n- Informations \n- Debug", // adv
    ...
    "_root_extra_excludeNotificationsWithoutId.description": "식별 구조가 포함되지 않은 알람은 표시하지 않습니다.", // adv
    // Others
