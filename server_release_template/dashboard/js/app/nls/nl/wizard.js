define({
    ...
    "textHardwareReq": "ALVR heeft een discrete en recente grafische kaart nodig. <br/> <br/> Zorg ervoor dat je minstens één audio uitvoerapparaat hebt. <br/> <br/> ",
    "YourGPUIs": "Jouw GPU:",
    ...
    "textTracking": "Hoe moet het volgen van de controller worden afgehandeld?. Als je een spel speelt waarbij er snelle bewegingen nodig zijn zoals: Beatsaber, kies medium of snel. Voor spellen met tragere beweging zoals Skyrim, laat het dan op normaal staan.\n\nOculus voorspelling betekent dat de controller positie voorspelt word op headset in de plaats van op de PC via SteamVR.",
    ...
    "textPerformance": "Kies een voorinstelling die bij uw setup past. Hierdoor worden er enkele instellingen voor u aangepast.",
    ...
    "textFinished": "Je kan altijd deze installatie wizard herstarten via de \"Installation\" tablad aan je linkerkant",
    "buttonNext": "Volgende",
    "buttonClose": "Sluiten",
});
