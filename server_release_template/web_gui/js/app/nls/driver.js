define({
    "root": {
        ...
        "driverNotice": "IMPORTANT: Since ALVR v13.1.0, registering the driver is discouraged. Now the driver registration is needed only when you want to launch SteamVR by itself or when you want to use ALVR together with other SteamVR drivers, like driver4all for full body tracking.",
    },
    "it": true,
    "es": true,
    "fr": true,
