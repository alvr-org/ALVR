define({
    ...
    "textHardwareReq": "ALVR requiere una tarjeta gráfica dedicada reciente (los gráficos Intel HD no son compatibles). Aquí puedes ver una <a href='https://github.com/polygraphene/ALVR/wiki/Supported-GPU'>lista de GPUs soportadas</a>. <br/> <br/> Asegúrate de tener al menos un dispositivo de salida de audio. <br/> <br/> ",
    "YourGPUIs": "Tu GPU es",
    "GPUSupported": " \nExcelente! Esta placa de video esta probablemente soportada!",
    "GPUUnsupported": " \nLo sentimos, pero esta placa de video no parece soportada. Puedes probar ALVR y ver si funciona.",
    // Software page
