define({
    ...
    "textSoftwareReq": "Assurez vous d'avoir installé SteamVR, et de l'avoir lancé au moins une fois. <br/> <br/> Si vous ne l'avez pas deja fait, veuillez installer la derniere version de <a  target='_blank' href='https://support.microsoft.com/it-it/help/2977003/the-latest-supported-visual-c-downloads'>Visual C++ Redistrubutable x64</a>. <br/> <br/> Pour transemettre l'audio du microphone veuillez installer <a  target='_blank' href='https://www.vb-audio.com/Cable/'>Cable audio virtuel</a>.",
