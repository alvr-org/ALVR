define({
    ...
    "textHardwareReq": "ALVRには高性能なグラフィックボードが必要です（CPU内蔵のIntel HD Graphicsには対応していません）. サポートされているGPUの一覧は<a href='https://github.com/polygraphene/ALVR/wiki/Supported-GPU'>こちら</a>に記載しています. <br/> <br/> また, 少なくとも1つのオーディオ出力機器があることを確認してください.",
