define({
    "root": {
        ...
        "_root_video_preferredFps.name": "Custom refresh rate", //
        ...
        "_root_video_secondsFromVsyncToPhotons.name": "Seconds from VSync to image",
        "_root_video_secondsFromVsyncToPhotons.description": "The time elapsed from the virtual VSync until the image is visible on the viewer screen",
        "_root_video_ipd.name": "Interpupillary distance",
        "_root_video_ipd.description": "The distance between the eyes measured from the center of the pupils.",
        ...
        "_root_video_colorCorrection.description": "Color correction are applied in the following order: Sharpening, Gamma, Brightness, Contrast, and Saturation.",
        ...
        "_root_audio_gameAudio.description": "Stream the game audio to the headset",
        ...
        "_root_audio_gameAudio_content_device.name": "Audio device code",
        "_root_audio_gameAudio_content_device.description": "Enter the audio device code used to capture audio",
        ...
        "_root_audio_microphone_enabled.name": "Unused",
        ...
        "_root_audio_microphone_content_device.name": "Virtual microphone input code",
        ...
        "_root_headset_universeId.name": "Universe ID",
        "_root_headset_serialNumber.name": "Serial number",
        "_root_headset_serialNumber.description": "Serial number of the emulated headset",
        "_root_headset_trackingSystemName.name": "Tracking system name",
        "_root_headset_trackingSystemName.description": "Name of the emulated headset tracking system",
        "_root_headset_modelNumber.name": "Model number",
        "_root_headset_modelNumber.description": "Model number of the emulated headset",
        "_root_headset_driverVersion.name": "Driver version",
        "_root_headset_driverVersion.description": "Driver version of the emulated headset",
        "_root_headset_manufacturerName.name": "Manufacturer name",
        "_root_headset_manufacturerName.description": "Manufacturer name of the emulated headset",
        "_root_headset_renderModelName.name": "Render model name",
        "_root_headset_renderModelName.description": "Render model name of the emulated headset",
        "_root_headset_registeredDeviceType.name": "Registered device type",
        "_root_headset_registeredDeviceType.description": "Registered device type of the emulated headset",
        ...
        "_root_headset_positionOffset.name": "Headset position offset",
        "_root_headset_positionOffset.description": "Headset position offset used by the position prediction algorithm.",
        ...
        "_root_headset_controllers.description": "Allow the use of the controllers",
        "_root_headset_controllers_enabled.name": "Enable",
        ...
        "_root_headset_controllers_content_modeIdx.name": "Mode Index",
        "_root_headset_controllers_content_modeIdx.description": "Mode index of the emulated controller",
        "_root_headset_controllers_content_trackingSystemName.name": "Tracking system name",
        "_root_headset_controllers_content_trackingSystemName.description": "Name of the emulated controller tracking system",
        "_root_headset_controllers_content_manufacturerName.name": "Manufacturer name",
        "_root_headset_controllers_content_manufacturerName.description": "Manufacturer name of the emulated controller",
        "_root_headset_controllers_content_modelNumber.name": "Model number",
        "_root_headset_controllers_content_modelNumber.description": "Model number of the emulated controller",
        "_root_headset_controllers_content_renderModelNameLeft.name": "Model number (Left hand)",
        "_root_headset_controllers_content_renderModelNameLeft.description": "Model number of the emulated left hand controller",
        "_root_headset_controllers_content_renderModelNameRight.name": "Model number (Right hand)",
        "_root_headset_controllers_content_renderModelNameRight.description": "Model number of the emulated right hand controller",
        "_root_headset_controllers_content_serialNumber.name": "Serial number",
        "_root_headset_controllers_content_serialNumber.description": "Serial number of the emulated controller",
        "_root_headset_controllers_content_ctrlType.name": "Controler type",
        "_root_headset_controllers_content_ctrlType.description": "Type of the emulated controller",
        "_root_headset_controllers_content_registeredDeviceType.name": "Registered device type",
        "_root_headset_controllers_content_registeredDeviceType.description": "Registered device type of the emulated controller",
        "_root_headset_controllers_content_inputProfilePath.name": "Input profile path",
        "_root_headset_controllers_content_inputProfilePath.description": "Input profile path of the emulated controller",
        ...
        "_root_connection_suppressFrameDrop.description": "ALVR will try to avoid packet loss.",
        ...
        "_root_connection_listenHost.description": "IP used by ALVR configuration tool",
        "_root_connection_listenHost.name": "Server streaming IP",
        "_root_connection_listenHost.description": "IP used by the server to receive packets",
        "_root_connection_listenPort.name": "Server streaming port",
        "_root_connection_listenPort.description": "Port used by the server to receive packets.",
        "_root_connection_throttlingBitrateBits.name": "Maximum streaming bitrate",
        "_root_connection_throttlingBitrateBits.description": "Maximum allowed bitrate in bit/s.",
        ...
        "_root_connection_frameQueueSize.name": "Frames queue size",
        ...
        "_root_extra_notificationLevel_info-choice-.name": "Information",
        "_root_extra_notificationLevel_debug-choice-.name": "Debug",
        "_root_extra_excludeNotificationsWithoutId.name": "Exclude notifications without identification",
        "_root_extra_excludeNotificationsWithoutId.description": "Do not show notifications that do not contain the identification structure.",
        // Others
