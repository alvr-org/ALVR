define({
    ...
    "_root_video_refreshRate.name": "刷新率",
    ...
    "_root_video_eyeFov.name": "视野大小",
    "_root_video_eyeFov.description": "视野大小",
    "_root_video_eyeFov_0_eyeFov_0.name": "左眼",
    "_root_video_eyeFov_0_eyeFov_0.description": "左眼的设置",
    "_root_video_eyeFov_0_left.name": "左",
    "_root_video_eyeFov_0_left.description": "左",
    "_root_video_eyeFov_0_right.name": "右",
    "_root_video_eyeFov_0_right.description": "右的值",
    "_root_video_eyeFov_0_top.name": "上",
    "_root_video_eyeFov_0_top.description": "上的值",
    "_root_video_eyeFov_0_bottom.name": "下",
    "_root_video_eyeFov_0_bottom.description": "下的值",
    "_root_video_eyeFov_1_eyeFov_1.name": "右眼",
    "_root_video_eyeFov_1_eyeFov_1.description": "右眼的设置",
    "_root_video_eyeFov_1_left.name": "左",
    "_root_video_eyeFov_1_left.description": "左",
    "_root_video_eyeFov_1_right.name": "右",
    "_root_video_eyeFov_1_right.description": "右的值",
    "_root_video_eyeFov_1_top.name": "上",
    "_root_video_eyeFov_1_top.description": "上的值",
    "_root_video_eyeFov_1_bottom.name": "下",
    "_root_video_eyeFov_1_bottom.description": "下的值",
    ...
    "_root_video_colorCorrection_content_sharpening.name": "正在粉碎",
    ...
    "_root_video_codec-choice-.description": "使用的视频编解码器\ n如果可能,请选择h265以在较低比特率下获得更好的视觉质量",
    "_root_video_codec_H264-choice-.name": "H264",
    "_root_video_codec_H264-choice-.description": "选择串流编解码器",
    "_root_video_codec_HEVC-choice-.name": "HEVC（h265）",
    "_root_video_codec_HEVC-choice-.description": "使用HEVC（h265）编解码器",
    ...
    "_root_headset_useTrackingReference.name": "使用跟踪参考",
    "_root_headset_useTrackingReference.description": "未使用",
    ...
    "_root_headset_controllers_content_triggerMode.name": "触发器模式",
    "_root_headset_controllers_content_triggerMode.description": "未使用",
    "_root_headset_controllers_content_trackpadClickMode.name": "触控板的点击模式",
    "_root_headset_controllers_content_trackpadClickMode.description": "未使用",
    "_root_headset_controllers_content_trackpadTouchMode.name": "触控板触摸模式",
    "_root_headset_controllers_content_trackpadTouchMode.description": "未使用",
    "_root_headset_controllers_content_backMode.name": "返回模式",
    "_root_headset_controllers_content_backMode.description": "未使用",
    "_root_headset_controllers_content_recenterButton.name": "重新设置按钮",
    "_root_headset_controllers_content_recenterButton.description": "未使用",
    ...
    "_root_connection_listenHost.name": "服务器IP",
    "_root_connection_listenHost.description": "服务器监听IP",
    ...
    "_root_connection_sendingTimeslotUs.name": "发送时隙",
    "_root_connection_sendingTimeslotUs.description": "未使用",
    "_root_connection_limitTimeslotPackets.name": "限制时隙包",
    "_root_connection_limitTimeslotPackets.description": "未使用",
    ...
    "_root_extra_revertConfirmDialog.description": "在将设置恢复为默认值之前要求确认",
    "_root_extra_restartConfirmDialog.name": "确认重启",
    "_root_extra_restartConfirmDialog.description": "在重新启动SteamVR之前要求确认",
