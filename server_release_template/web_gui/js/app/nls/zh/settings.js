define({
    ...
    "_root_video_recommendedTargetResolution-choice-.description": "已请求SteamVR进行渲染的帧分辨率", // adv
    ...
    "_root_headset_controllers_content_positionOffsetLeft.description": "左侧控制器的位置偏移（以米为单位）。\n对于右侧控制器,x值被镜像", // adv
    ...
    "_root_headset_controllers_content_rotationOffsetLeft.description": "左控制器的旋转偏移量,以度为单位。\n对于右控制器,沿Y和Z轴的旋转是镜像的", // adv
