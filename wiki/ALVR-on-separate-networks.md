...
# ALVR Experimental v11 and Below
ALVR Experimental v7 or newer is recommended for this type of configuration.

This configuration is **NOT** supported in ALVR v12.0.0 and later. The latest release to still support this is Experimental v11
...
* **Warning!** SteamVR allows to control a desktop from your VR headset (i.e. a **malicious ALVR client could take over the PC**). 
