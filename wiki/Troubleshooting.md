...
Check that the PC app and the headset app run on the latest version of ALVR. At the time of writing, the latest stable version is `v19.0.0`, latest nightly being `v20.0.0dev06`. If your version is `v2.3.1` or `v2.4.0-alpha5` then you downloaded ALVR from the wrong link. The correct link is https://github.com/alvr-org/ALVR.
 ...
 * Open ports `9943` and `9944`, both TCP and UDP, on your firewall
...
## ALVR sees the headset, and SteamVR shows headset icon
